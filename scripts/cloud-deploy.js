...
async function triggerGitHubDeployment() {
  ...
  try {
    ...
    if (status.trim() !== '') {
      ...
      execSync('git commit -m "feat: trigger development deployment"', { stdio: 'inherit' });
    ...
    // Provide next steps
    console.log('\n🎯 Next Steps:');
    console.log('1. 🔗 Monitor deployment: https://github.com/pankaj-davi/shopify-image-search-app/actions');
    ...
    console.log('\n💡 Alternative options:');
    console.log('1. 🌐 Manual trigger: Go to GitHub Actions and click "Run workflow"');
...
async function showDeploymentStatus() {
  ...
  try {
    ...
    if (branch === 'develop') {
      ...
      logInfo(`Current branch: ${branch}. Switch to develop for auto-deployment.`);
    }
    
    console.log('\n🔗 Useful Links:');
    console.log('• GitHub Actions: https://github.com/pankaj-davi/shopify-image-search-app/actions');
    console.log('• Repository: https://github.com/pankaj-davi/shopify-image-search-app');
    console.log('• Latest Workflows: Check the Actions tab for deployment status');
...
async function showManualTriggerInstructions() {
  ...
  console.log('   • Go to: https://github.com/pankaj-davi/shopify-image-search-app/actions');

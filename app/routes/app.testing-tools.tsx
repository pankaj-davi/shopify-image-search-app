          ...
          <BlockStack gap="400">
            ...
            <Banner tone="warning">
              <Text as="p" variant="bodyMd">
                ...
                Shopify store to test visual search:
              </Text>
            </Banner>
            <Box
            ...
            >
              <InlineStack align="center">
                <Button url={bookmarkletCode} variant="primary" size="large">
                  🔍 Test Visual Search
                </Button>
              </InlineStack>
            </Box>
            <Text as="p" variant="bodyMd" tone="subdued">
              ...
              <br />
              2. Visit any Shopify store (or your test store)
              <br />
              3. Click the bookmark to inject visual search
              <br />
            ...
            <BlockStack gap="300">
              <BlockStack gap="200">
                ...
                <Box paddingInlineStart="400">
                  <BlockStack gap="100">
                    ...
                    <Text as="p" variant="bodyMd">
                      ✅ Script endpoint is accessible:{' '}
                      <code>{appUrl}/visual-search-script.js</code>
                    </Text>
                    <Text as="p" variant="bodyMd">
                      ✅ API endpoint responds:{' '}
                      <code>{appUrl}/api/visual-search</code>
                    </Text>
                  </BlockStack>
                </Box>
              </BlockStack>
              ...
              <BlockStack gap="200">
                ...
                <Box paddingInlineStart="400">
                  <BlockStack gap="100">
                    ...
                    <Text as="p" variant="bodyMd">
                      ✅ Script tag appears in Shopify admin (Online Store →
                      Themes → Actions → Edit code → Templates)
                    </Text>
                    <Text as="p" variant="bodyMd">
                      ✅ No errors in app logs during installation
                    </Text>
                    <Text as="p" variant="bodyMd">
              ...
              <BlockStack gap="200">
                ...
                <Box paddingInlineStart="400">
                  <BlockStack gap="100">
                    <Text as="p" variant="bodyMd">
                      ✅ Camera icons appear in search bars
                    </Text>
                    <li>
                    ...
                    <Text as="p" variant="bodyMd">
                      ✅ Image upload works (check browser network tab)
                    </Text>
                    <Text as="p" variant="bodyMd">
                      ✅ Search terms are generated and filled
                    </Text>
                    <Text as="p" variant="bodyMd">
              ...
              <BlockStack gap="200">
                ...
                <Box paddingInlineStart="400">
                  <BlockStack gap="100">
                    <Text as="p" variant="bodyMd">
                      ✅ Test with Dawn theme
                    </Text>
                    <Text as="p" variant="bodyMd">
                      ✅ Test with Debut theme
                    </Text>
                    <Text as="p" variant="bodyMd">
                      ✅ Test with at least one custom theme
                    </Text>
                    <Text as="p" variant="bodyMd">
                      ✅ Test on stores with multiple search bars
                    </Text>
                    <Text as="p" variant="bodyMd">
                      ✅ Test on stores with AJAX/SPA navigation
                    </Text>
                  </BlockStack>
                </Box>
              </BlockStack>
              ...
              <BlockStack gap="200">
                ...
                <Box paddingInlineStart="400">
                  <BlockStack gap="100">
                    <Text as="p" variant="bodyMd">
                      ✅ Script tags are removed when app is uninstalled
                    </Text>
                    <Text as="p" variant="bodyMd">
              ...
              <BlockStack gap="200">
                ...
                <Box paddingInlineStart="400">
                  <BlockStack gap="100">
                    ...
                    <Text as="p" variant="bodyMd">
                      ✅ Camera access works (mobile only)
                    </Text>
                    <Text as="p" variant="bodyMd">
            ...
            <BlockStack gap="300">
              <BlockStack gap="200">
                ...
                >
                  <Text as="p" variant="bodyMd">
                    <code>
                      console.log(window.injectVisualSearchIcon ? 'Visual search
                      loaded' : 'Visual search not found');
                    </code>
                  </Text>
                </Box>
              ...
              <BlockStack gap="200">
                ...
                <Box paddingInlineStart="400">
                  <BlockStack gap="100">
                    ...
                    <Text as="p" variant="bodyMd">
                      Image uploads have proper Content-Type
                    </Text>
                    <Text as="p" variant="bodyMd">
                      No CORS errors
                    </Text>

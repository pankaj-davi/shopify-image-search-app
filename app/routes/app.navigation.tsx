      ...
      links: [
        {
          ...
          variant: 'primary',
          description:
            'Real-time preview with positioning controls, color themes, and configuration generator',
        },
        {
          ...
          variant: 'secondary',
          description:
            'Script injection, cleanup, and core visual search settings',
        },
        {
          url: '/app/additional',
          ...
          variant: 'secondary',
          description:
            'Usage statistics, performance metrics, and user behavior insights',
        },
      ],
    },
    {
      ...
      links: [
        {
          ...
          variant: 'secondary',
          description:
            'Check installation status and troubleshoot common issues',
        },
        {
          ...
          variant: 'secondary',
          description:
            'Debug visual search functionality and test different scenarios',
        },
      ],
    },
    {
      ...
      links: [
        {
          ...
          external: true,
          description:
            'Interactive demo to test left/right positioning, spacing, and sizing',
        },
        {
          ...
          external: true,
          description:
            'See how collision detection prevents overlap with existing icons',
        },
        {
      ...
      links: [
        {
          ...
          external: true,
          description:
            'Comprehensive guide covering all positioning and customization options',
        },
        {
          ...
          external: true,
          description:
            'Full project documentation including setup and development guides',
        },
        {
      ...
      links: [
        {
          ...
          variant: 'tertiary',
          description:
            'Reset all customizations to default Pinterest-style theme',
        },
        {
          ...
          variant: 'tertiary',
          description:
            'Force re-injection of the visual search script to your storefront',
        },
        {
          url: `${data.appUrl}/app`,
        ...
        <Card>
          <BlockStack gap="200">
            ...
            <Text variant="bodyMd" as="p" tone="subdued">
              Complete navigation for all visual search features, tools, and
              resources for {data.shop}
            </Text>
          </BlockStack>
        </Card>
        ...
        <Card>
          <BlockStack gap="200">
            ...
            <ol style={{ marginLeft: '20px', lineHeight: '1.8' }}>
              <li>
                <strong>Preview & Customize:</strong> Visit the Theme Preview
                page to configure positioning and colors
              </li>
              <li>
                <strong>Test Integration:</strong> Use the Verification tool to
                ensure everything is working
              </li>
              <li>
                <strong>Explore Demos:</strong> Try the interactive positioning
                demos to understand the features
              </li>
              <li>
                <strong>Monitor Analytics:</strong> Check the Analytics

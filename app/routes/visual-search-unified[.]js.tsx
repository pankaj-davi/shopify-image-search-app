...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  console.log(`[Script Serving] Loading script for shop: ${shop}, timestamp: ${timestamp}`);
  console.log(`[Script Serving] App URL from env: ${process.env.SHOPIFY_APP_URL}`);
  ...
  try {
    ...
    if (shopData && shopData.themeConfig) {
      ...
      console.log(`[Script Serving] No theme config found for shop: ${shop}. ShopData exists: ${!!shopData}, Has themeConfig: ${!!(shopData && shopData.themeConfig)}`);
    }
  } catch (error) {
